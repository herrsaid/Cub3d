...
CC=gcc
NAME=cub3d
SRC=main.c src/utils.c src/move.c src/draw_utils.c src/calc_utils.c map_parser/get_map.c map_parser/get_next_line_utils.c map_parser/get_next_line.c map_parser/utils.c 
FLAGS=-Imlx -c $< -o $@
